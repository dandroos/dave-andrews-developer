          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={7}>
              <Typography paragraph>
                ...
                internet was in its relative infancy. Over the years since, I
                have learnt how to code using <strong>HTML5</strong>,{" "}
                <strong>CSS3</strong>,{` `}
                <strong>JavaScript</strong>, <strong>Java</strong>,{" "}
                <strong>PHP</strong>, <strong>Node</strong>,{" "}
                <strong>Python</strong> and <strong>C#</strong>. I love the
                almost infinite opportunities to learn that web/app development
                opens up to me. I'm taking my first steps into game development
                right now and I'm enjoying the challenge!
              </Typography>
              <Typography>
                When I'm not working, I enjoy gaming (Xbox baby!), photography,
                and cycling. As an amateur musician, I also love to play the
                piano and drums and I occasionally make chiptune (8 bit)
                versions of music by Bach and Vivaldi.
              </Typography>
            </Grid>
...
export default connect(stp)(About)
