    ...
    <PageWrapper title="Services">
      ...
      <Service title="Websites">
        <Typography paragraph>
          I have been creating websites since my teens (that means for a long
          time!). Although the technology has changed and improved substantially
          over the years, the basic challenge remains the same. It's mostly
          about finding the sweet spot between aesthetic and function, and I
          enjoy it very much!
        </Typography>
        <Typography paragraph>
          As I am primarily a web developer, I am proficient with{" "}
          <strong>HTML5</strong>, <strong>CSS</strong> and{" "}
          <strong>Javascript</strong> (the holy trinity for web development!). I
          am also an expert in <strong>React</strong>, <strong>Gatsby</strong>{" "}
          and <strong>Next</strong> which are the main frameworks/solutions I
          normally use to create websites and applications.
        </Typography>
      ...
      <Service title="Business Solutions">
        <Typography>
          ...
          automation and smart solutions is almost priceless! I have experience
          with numerous technologies and programming languages to achieve this.
        </Typography>
      </Service>
